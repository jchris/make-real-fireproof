export async function fetchFromOpenAi(
  ...
  const apiKey = providedApiKey ?? process.env.NEXT_PUBLIC_OPENAI_API_KEY

  if (!apiKey) {
    throw new Error(
      'You need to provide an API key. Make sure NEXT_PUBLIC_OPENAI_API_KEY is set in your .env file.'
    )
  }
